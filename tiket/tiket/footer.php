<footer class="page-footer" style="background-color: #0f0f0f;">
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                ...
                <p class="grey-text text-lightent-4">Pesan tiket  hanya dengan 1 klik.</p>
            </div>
    ...
    <div class="footer-copyright">
        <div class="container">
            &copy; 2018 OnlTic | Repost by <a href="https://stokcoding.com/" title="StokCoding.com" target="_blank">StokCoding.com</a>
        </div>
    </div>
</footer>
